        ...
        <div class="col-9">
          <div class="card" style = "margin-top: 20px;">
            ...
            <div class="card-header" >
              <span style = "display: inline-block; font-size: 120%; margin-top: 5px; margin-left: 5px;">我的Bot</span>
              ...
              <table class="table table-striped table-hover">
                  ...
                  <tbody>
                      <tr v-for="bot in bots" :key = "bot.id">
                        ...
                        <td>{{bot.rating}}</td>
                        <td>
                          <button type="button" class="btn btn-secondary" style = "margin-right: 10px;" data-bs-toggle="modal" :data-bs-target="'#update_' + bot.id">修改</button>
                          <button type="button" class="btn btn-danger" data-bs-toggle="modal" :data-bs-target="'#remove_' + bot.id">删除</button>
                        </td>

                            <!-- Modal -->
                            <div class="modal fade" :id="'remove_'+ bot.id" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" :id="'update_'+ bot.id" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="mb-3">
                                        <label for="add_bot_content" class="form-label">代码</label>
                                        <VAceEditor
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消  </button>
            <button type="button" class="btn btn-primary" @click = "update_bot(bot)">创建</button>
          </div>
        </div>
      </div>
    </div>
      ...
      const remove_bot = (bot) =>{
        $.ajax({
          ...
          success(resp){
            if(resp.error_message === "success"){
              refrest_bots();
              Modal.getInstance('#remove_'+ bot.id).hide(); 
            }
          },
          error(resp){
            console.log(resp);
      ...
      const update_bot = (bot) => {
        ...
        $.ajax({
          ...
          success(resp){
            if(resp.error_message === "success"){
              refrest_bots();
              Modal.getInstance('#update_'+ bot.id).hide(); 
            }else{
