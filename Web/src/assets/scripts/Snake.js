...
export class Snake extends GameObject{
    constructor(info, gamemap) {
        ...
        this.cells = [new Cell(info.r, info.c)];//蛇的身体，cells[0]为蛇头
        this.next_cell = null;
        this.speed = 5;
        this.step = 0;
        this.eps = 1e-2;

        this.direction = -1; //0 1 2 3 表示 上右下左
        this.status = 'stop'; //  stop move die
    ...
    update_move(){
        ...
        if (distance < this.eps){ //表示可以停止了
            this.status = 'stop'; // 走完了，停下来
